...
//set up data states for each section
function Data(props){
    return (<div>
...
//callback function to send data to db
function update(section, value) {
    return new Promise((resolve, reject) => {
        //route defined on express to connect to redis
        var url = `/update/${section}/${value}`;
        //superagent used to make request        
        superagent
            .get(url)
...
//callback function to get information from database
function read() {
    return new Promise((resolve, reject) => {
        var url = '/data';
        superagent
